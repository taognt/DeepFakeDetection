...
file_path = os.path.join(os.path.dirname(__file__), "e4s_dataset.pth")
data = torch.load(file_path,weights_only=False)
test_subset = data['test']
test_dataset_size = len(test_subset)
test_loader=DataLoader(test_subset,batch_size=32, shuffle=False)
#
model_path="./models/best_model_xception_e4s.pth"
model = Xception()
...
plt.savefig("confusion_matrix_e4s.png")  # Sauvegarder dans un fichier
